...
def verify_camera(cam):
    ...
    extrinsic_path = os.path.join(base_dir, f"data/calibration/extrinsic/params/extrinsic_{cam}.npz")
    ...
    if ret:
        ...
        print(f"[{cam}] Reprojection Error: Mean = {mean_error:.4f}px, Max = {max_error:.4f}px")
    else:
    ...
    for pt in img_pts_proj:
        ...
        cv2.circle(vis_img, (x, y), 5, (0, 255, 0), -1)  # Draw predicted points in Green
