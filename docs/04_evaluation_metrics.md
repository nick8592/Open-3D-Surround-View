...
Because fisheye distortion and 3D space are hard to perfectly "eyeball," we designed three mathematical pillars inside our `/pipeline/calibration` and `/pipeline/bev_2d` codebase to categorically evaluate the *goodness* of the calibration.
